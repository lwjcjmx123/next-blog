---
title: '前端性能优化'
slug: 'frontend-optimization-checklist'
excerpt: '这么多前端优化点你都记得住吗？全面的前端性能优化策略和技巧汇总。'
date: '2017-11-09'
published: true
...
> 围绕前端的性能多如牛毛，涉及到方方面面，以我我们将围绕 PC 浏览器和移动端浏览器的优化策略进行罗列 注意，是罗列不是展开，遇到不会不懂的点还请站外扩展
